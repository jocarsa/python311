...
max_elements_to_show = 10  # Change this to the number of elements you want to display
...
with open(f"{output_folder}{titulo}.html", "w") as informe:
    ...
    for columna_nombre, columna in contenido.items():
        ...
        value_counts = columna.value_counts()[:max_elements_to_show]  # Limit elements to display
